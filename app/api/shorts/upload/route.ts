...
// Upload one short. The channel is not a choice: parseChannel answers with the
// only library this app has, whatever the form field says.
export async function POST(request: Request) {
  ...
  const channel = parseChannel(String(form.get("channel") || "18plus"));
