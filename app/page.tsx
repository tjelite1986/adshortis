...
// The immersive feed. The genre filter lives in the player's 3-dot menu and in
// the chips on /explore; both scope this feed through the `cat` param, so a
// reload or a Back lands in the same slice.
...
export default async function ShortsPage(
  ...
  return (
    <ShortsFeed
      key={(category ?? "all") + ":" + sort + ":" + length + ":" + (tag ?? "")}
      channel="18plus"
