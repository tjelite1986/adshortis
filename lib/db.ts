...
function migrate(db: Database.Database) {
  db.exec(`
    ...
    -- to the rows that were migrated in — but this app serves '18plus' only.
    -- The main channel is a separate app with a library of its own.
    CREATE TABLE IF NOT EXISTS shorts (
      id INTEGER PRIMARY KEY AUTOINCREMENT,
      channel TEXT NOT NULL DEFAULT '18plus',
...
// Kept as a union even though this app only ever writes '18plus': the column is
