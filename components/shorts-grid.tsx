...
export default function ShortsGrid({
  ...
  // Admins get a per-tile category selector to sort clips into their bucket.
            ...
            {(() => {
              ...
              const overlay = (
                <>
                  ...
                  {s.is_private && (
                    <div className={cn(
                      "pointer-events-none absolute rounded bg-black/65 p-1 text-amber-300",
                      categoryEditable ? "left-1 top-7" : "left-1 top-1"
                    )}>
                      <Lock size={12} />
                    </div>
                  )}
