...
export default function ShortsGrab() {
  ...
  // One channel, so nothing to pick: a grab always lands in this app's library.
  // The state stays a variable rather than a literal because every request below
  // carries it, and the day a second channel exists the picker comes back.
